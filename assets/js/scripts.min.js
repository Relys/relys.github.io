function initSearch() {
	if(document.getElementsByTagName("q").length!=0)
	{
		getParameterByName("q") && (q = decodeURIComponent(getParameterByName("q")), $searchInput.val(q), execSearch(q)),
		$(document).on("submit", $searchForm, function (a) {
			a.preventDefault(),
			q = $searchInput.val(),
			execSearch(q)
	})
...
function processData() {
	...
	function (a) {
		...
		showLoader && toggleLoadingClass(),
		populateResultsString(b),
		showSearchResults(c)
	}
}
...
function populateResultContent(a, b) {
	return a = injectContent(a, b.title, "##Title##"),
	a = injectContent(a, b.link, "##Url##"),
	a = injectContent(a, b.excerpt, "##Excerpt##"),
	a = injectContent(a, b.date, "##Date##")
}
...
(window.jQuery || window.Zepto), function (a) {
	...
	u.prototype = {
		...
		open : function (c) {
			...
			if (b.isOpen)
				return b.updateItemHTML(), void 0;
			b.types = [],
			g = "",
...
var responsiveNav = function (a, b) {
	...
	n = function (a) {
		for (var b = a.firstChild; null !== b && 1 !== b.nodeType; )
			b = b.nextSibling;
		return b
	},
	o = function (a, b) {
...
(window, document), q, jsonFeedUrl = "/search.json", $searchForm = $("[data-search-form]"), $searchInput = $("[data-search-input]"), $resultTemplate = $("#search-result"), $resultsPlaceholder = $("[data-search-results]"), $foundContainer = $("[data-search-found]"), $foundTerm = $("[data-search-found-term]"), $foundCount = $("[data-search-found-count]"), allowEmpty = !0, showLoader = !0, loadingClass = "is--loading";
